    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(blank=True, default='', help_text='Department or branch of study', max_length=100)),
                ('year_of_study', models.PositiveSmallIntegerField(blank=True, choices=[(1, '1st Year'), (2, '2nd Year'), (3, '3rd Year'), (4, '4th Year'), (5, '5th Year')], null=True)),
                ...
                ('role', models.CharField(choices=[('admin', 'Super Admin'), ('organizer', 'Event Organizer'), ('participant', 'Participant')], default='participant', max_length=20)),
