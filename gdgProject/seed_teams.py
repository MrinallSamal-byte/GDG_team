...
from team.models import Team, TeamMembership, MemberRole, TeamStatus
from events.models import Event
from registration.models import Registration, RegistrationType, RegistrationStatus
...
for i in range(1, 101):
    ...
    user = User(username=username, email=email, first_name=f"Bot", last_name=f"{i}")
